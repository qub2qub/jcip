...
/**
 * Есть пять остановок. <p>
 * На первых четырех из них могут стоять пассажиры и ждать автобуса. <p>
 * Автобус выезжает из парка и останавливается на каждой остановке на некоторое время. <p>
 * После конечной остановки автобус едет в парк. <p>
 * Нам нужно забрать пассажиров и высадить их на нужных остановках. <p>
 */
public class BusPhaser {
