    ...
    public V compute(final A arg) throws InterruptedException {
        while (true) {
            ...
            if (f == null) {
                ...
                // вопрос: а когда мы стартуем фьючу в первый раз? ответ: когда вернулся нулл.
                // а если вернулось какое-то значение -- то берём от него только гет, в этот if не заходим.
